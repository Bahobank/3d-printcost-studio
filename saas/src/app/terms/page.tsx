  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-12 text-slate-800">
      <article className="mx-auto w-full max-w-3xl rounded-3xl border border-slate-200 bg-white px-6 py-10 shadow-[0_20px_60px_rgba(15,23,42,0.06)] sm:px-12">
        <a href="/login" className="text-sm font-semibold text-blue-600 hover:text-blue-700">← Back to 3D PrintCost Studio</a>

        <h1 className="mt-6 text-3xl font-bold tracking-tight text-slate-950">Terms of Service</h1>
        ...
        <Section title="5. Your data">
          <p className="mt-2 leading-7">You retain ownership of the data you enter. Our handling of personal data is described in our <a className="font-semibold text-blue-600 hover:text-blue-700" href="/privacy">Privacy Policy</a>.</p>
        </Section>
        ...
        <Section title="7. Changes & contact">
          <p className="mt-2 leading-7">We may update these Terms from time to time. Questions? Contact us at <a className="font-semibold text-blue-600 hover:text-blue-700" href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>.</p>
        </Section>
      </article>
    </main>
  );
